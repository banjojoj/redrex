...
class PurchasesTabView(CTkTabview):
    ...
    def __init__(self, master):
        ...
        self.search_label, self.search_entry = helper.create_labeled_entry(master=t_first_row, label="Search Supplier:", row=0, column=0, width=305)
        ...
        status_options = ["All", "Paid", "Not Paid"]
