...
from gui.tabs.cust_tab import CustomerTabView
from tkinter import Menu
from controller import cust_ctrl
import helper


class CustomerView(CTkFrame):
    def __init__(self, master):
        ...
        columns = ("Name", "Address", "TIN-No", "Terms", "Balance")
        self.tree = Treeview(root=tree_frame, columns=columns)
        self.tree.show_customers()
        ...
        CTkLabel(master=title_frame, text="Customer", font=("Arial Black", 30), text_color="#99BC85").pack(anchor="nw", side="left")

        # Create Filter TabView
        self.customer_tabview = CustomerTabView(self)
        self.customer_tabview.pack(fill="x", padx=15)
